<?php
    if(  !isset($_GET['dashboard']) && !isset($_GET['user']) &&!isset($_GET['tuser']) &&!isset($_GET['conque']) && !isset($_GET['booking']) && !isset($_GET['market']) && !isset($_GET['brand']) && !isset($_GET['testimonial']) &&!isset($_GET['subscribers']) && !isset($_GET['about']) && !isset($_GET['Crop_prediction']) && !isset($_GET['contact'])  && !isset($_GET['crp']) && !isset($_GET['msg'])  &&!isset($_GET['image'])  ){ ?>
<div id ='bodyright'>
<html>
<head>
    <style>
